...
pub fn get_command_line_input() -> clap::ArgMatches<'static>  { //possibly remove static lifetimes once I become clear what the lifetimes of App are
    ...
    .arg(Arg::with_name("location_list")
        .short("l")
        .long("location")
    ...
    .arg(Arg::with_name("api")
        ...
        .takes_value(true))
    .arg(Arg::with_name("human_readable")
        .short("h")
        .long("human-readable")
        .help("Use human-readable text instead of CSV-like syntax"))
    .arg(Arg::with_name("ascii_image")
        .short("a")
        .long("ascii-image")
    ...
    .arg(Arg::with_name("graph")
        ...
        .value_name("METRICS")
        .takes_value(true))
    .arg(Arg::with_name("cache_duration")
        .long("cache-duration")
        .help("Specify the duration to cache previous results (in minutes)")
        .value_name("DURATION")
        .takes_value(true))
    .arg(Arg::with_name("significant_figures")
