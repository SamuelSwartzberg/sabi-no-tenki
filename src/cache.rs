...
pub fn get_result_from_cache(&cache_duration: chrono::Duration, cache_type: String, request: &Vec<String>)-> Option<Vec<String>>{ 
...
pub fn cache_result(result: &Vec<String>, cache_type: String, request: &Vec<String>) {
